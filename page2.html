...
<body>
    <div class="box-wrapper intro">
        <div class="other-writings">
            <h2>insert</h2>
            <h5>insert</h5>
            <img src="insert image" alt="insert image" width="240" height="240">
            <p>insert
            </p>
            <p>insert
            </p>
            <img src="insert image" alt="insert image" width="240" height="240" style="float: right;">insert
            </p>
            <p>insert</p>
            <br><br>
            <div class="line">
            ...
            <h2>insert</h2>
            <h5>insert</h5>
            <div class="other-writings-box">
                <img src="insert image" alt="insert image" width="240" height="240">
                <div class="other-writings-text">insert
                </div>
            </div>
            <p></p>
            <p>insert
